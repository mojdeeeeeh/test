         ...
         <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
               ...
               <li class="user-header">
                  <img src="{{ asset('theme/dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                  <p>
                     {{ Auth::user()->name }} -  {{ env('APP_NAME') }} / {{ request()->path() }}
      ...
      <ul class="sidebar-menu" data-widget="tree">
         ...
         <li class="active treeview">
            ...
            <ul class="treeview-menu">
               <li class="active"><a href="{{ url('dashboard-1') }}"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
               <li><a href="{{ url('dashboard-2') }}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
            </ul>
         </li>
         <li>
            <a href="{{ url('home') }}">
            <i class="fa fa-pagelines text-aqua"></i> <span>page</span>
            <span class="pull-right-container">
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               <li><a href="{{ url('tags') }}"><i class="fa  fa-check-square-o"></i>tags</a></li>
